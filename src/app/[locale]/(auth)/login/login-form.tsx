    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-xs text-gray-400 font-medium">v{APP_VERSION}</span>
        </div>
      ...
      <div className="space-y-4">
        ...
        {error && <div className="bg-orange-50 border border-orange-200 rounded-xl p-3 text-orange-600 text-sm">{error}</div>}

        <button
          className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2.5 rounded-xl disabled:opacity-50 flex items-center justify-center gap-2"
          onClick={handleLogin}
          disabled={loading}
        >
